...
const AES_KEY = "myverysecretkey123"; 
const ADMIN_SECRET = "admin-secret-demo";
...
app.post("/vote", (req, res) => {
    ...
    const payload = JSON.stringify({ choice, time: Date.now() });
    const encrypted = encryptText(payload);
